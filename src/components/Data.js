            ...
            <div key={item._id} className="postV mediaquery-post">
              ...
              <div className="message">
                <ul>
                  ...
                  <li>
                    <strong>Prerequisite Knowledge Required:</strong>
                    <br />
                    <div
                  ...
                  <li>
                    <strong>Thought-Provoking Question:</strong>
                    <br />
                    <div
                      className="quill-content"
                      dangerouslySetInnerHTML={{
                  ...
                  <li>
                    <strong>Analogy for Better Understanding:</strong>
                    <br />
                    <div
                      className="quill-content"
                      dangerouslySetInnerHTML={{
                ...
                <div className="post-footer">
                  ...
                  <div className="user-info">
                    <Link
                      className="Answer"
                      to="/answer2"
                      onClick={() => setwannaanswerthis(item.message.query)}
                    >
                      Answer
                    </Link>
                  </div>
