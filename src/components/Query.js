...
const Query = () => {
  ...
  return ( 
    ...
    <div style={{ 
      ...
      <p style={{ textAlign: 'center' }}>We're here to help you with any doubts you might have. Please enter your doubt in the box below and our community will do their best to help you.</p>
      <input 
        type="text" 
        value={inputValue} 
        onChange={handleInputChange} 
        placeholder="Enter your doubt here..." 
        style={{ padding: '10px', fontSize: '1em', width: '100%', borderRadius: '5px' }}
      />
